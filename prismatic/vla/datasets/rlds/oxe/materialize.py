...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.JOINT]:
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.JOINT:
        dataset_kwargs["absolute_action_mask"] = [False] * 9
        dataset_kwargs["action_normalization_mask"] = [True] * 9
